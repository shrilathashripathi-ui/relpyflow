      ...
      <div className="min-h-screen bg-gray-50 flex">
        ...
        <div className="flex-1 ml-64 p-8">
          <div className="max-w-2xl mx-auto text-center py-16">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Unlock Advanced Analytics</h2>
        ...
        <div className="p-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600">Track your DM performance and conversion rates</p>
            </div>
          ...
          <div className="grid grid-cols-5 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm text-gray-500">Total DMs</span>
              </div>
              <p className="text-3xl font-bold text-gray-900">{stats.totalDMs}</p>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <p className="text-sm text-green-600 mt-1">↑ 23% vs last period</p>
            </div>
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <div className="col-span-2 bg-white rounded-2xl p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-6">DM Performance</h3>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm font-medium text-gray-900">{stats.totalDMs * 3}</span>
                  </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-gray-600">DMs Sent</span>
                    <span className="text-sm font-medium text-gray-900">{stats.totalDMs}</span>
                  </div>
                  <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-gray-600">Replies</span>
                    <span className="text-sm font-medium text-gray-900">{stats.totalReplies}</span>
                  </div>
                  <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm mt-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-6">Top Performing Keywords</h3>
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-100">
                  <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">KEYWORD</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">DMs SENT</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">REPLIES</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">REPLY RATE</th>
              ...
              <tbody>
                {topKeywords.map((kw, index) => (
                  <tr key={index} className="border-b border-gray-50 hover:bg-gray-50">
                    ...
                    <td className="py-4 px-4 text-gray-900 font-medium">{kw.dms}</td>
                    <td className="py-4 px-4 text-gray-900 font-medium">{kw.replies}</td>
                    <td className="py-4 px-4">
                      <span className={`font-medium ${
                        parseFloat(kw.rate) >= 45 ? 'text-green-600' : 'text-gray-900'
                      }`}>
                        {kw.rate}
                      </span>
                    </td>
