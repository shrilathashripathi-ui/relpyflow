                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-100 dark:border-gray-700">
                      <th className="text-left py-4 px-6 font-medium text-gray-500 dark:text-gray-400 text-sm">USERNAME</th>
                      <th className="text-left py-4 px-6 font-medium text-gray-500 dark:text-gray-400 text-sm">COMMENT</th>
                      <th className="text-left py-4 px-6 font-medium text-gray-500 dark:text-gray-400 text-sm">KEYWORD</th>
                      <th className="text-left py-4 px-6 font-medium text-gray-500 dark:text-gray-400 text-sm">DM STATUS</th>
                      <th className="text-left py-4 px-6 font-medium text-gray-500 dark:text-gray-400 text-sm">DATE</th>
                      <th className="text-left py-4 px-6 font-medium text-gray-500 dark:text-gray-400 text-sm">AUTOMATION</th>
                    </tr>
                  </thead>
                  <tbody>
                    {contacts.map((contact) => (
                      <tr key={contact.id} className="border-b border-gray-50 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
