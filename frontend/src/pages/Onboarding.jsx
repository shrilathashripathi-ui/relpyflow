          ...
          {steps.map((step, index) => (
            <div key={step.number} className="flex items-center">
              <div className="flex flex-col items-center">
                ...
                <p className={`mt-2 text-sm font-medium ${currentStep >= step.number ? 'text-purple-600' : 'text-gray-500'}`}>
                  {step.title}
                </p>
              </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          {currentStep === 1 && (
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Connect Your Instagram</h2>
              ...
              <div className="bg-purple-50 rounded-2xl p-6 mb-8">
                <h3 className="font-semibold text-purple-900 mb-4">What you'll get:</h3>
          ...
          {currentStep === 2 && (
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Set Your First Keyword</h2>
              <p className="text-gray-600 mb-8 max-w-md mx-auto">
              ...
              <div className="mb-8">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-center text-lg font-medium"
                />
              </div>
                ...
                <div className="bg-white rounded-xl p-4 shadow-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 text-left">
                      <p className="text-sm"><span className="font-medium">@customer</span> commented:</p>
                      <p className="text-gray-600">"Hey, {testKeyword}!"</p>
                    </div>
                  </div>
                  <div className="mt-3 pl-13 ml-13 border-l-2 border-purple-500 pl-4">
                    <p className="text-sm text-purple-600 font-medium">↳ Auto DM sent!</p>
                  </div>
                </div>
              </div>
          ...
          {currentStep === 3 && (
            <div className="text-center">
              ...
              <button
                ...
                className="w-full mt-4 py-4 border-2 border-purple-200 text-purple-600 rounded-xl font-semibold text-lg hover:bg-purple-50 transition-all"
              >
